...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utilities_range__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utilities/range */ "./src/js/utilities/range.js");
...
var newRangeSlider = new _utilities_range__WEBPACK_IMPORTED_MODULE_0__["default"]('my-slider');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var rangeSlider = function rangeSlider(id) {
  var self = this;
  var startX = 0,
  ...
  var max = parseFloat(slider.getAttribute('rs-max')); // retrieve default values
